 ...
 * 转换对象为字符串.
 * <p/>
 * 不输出的请在getter或者field上标注{@link com.xdclass.shop.common.ToString.Invisible}
 * <p/>
 * 需要掩码的请在getter或者field上标注{@link com.xdclass.shop.common.ToString.Maskable}
 * <p/>
...
public class ToString {
    ...
    //public webapp String toString(Object o, int size) {
    //	if (o == null)
    //		return NULL;
